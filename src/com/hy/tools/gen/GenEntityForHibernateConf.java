...
public class GenEntityForHibernateConf {
	...
	public static void setDbType(DBType dbType) {
		GenEntityForHibernateConf.dbType = dbType;
	}
	...
	public static void setDbName(String dbName) {
		GenEntityForHibernateConf.dbName = dbName;
	}
	...
	public static void setGenerated(Object generated) {
		GenEntityForHibernateConf.generated = generated;
	}
	...
	public static void setSchemaname(String schemaname) {
		GenEntityForHibernateConf.schemaname = schemaname;
	}
	...
	public static void main(String[] args){
		GenEntityForHibernateConf.genAll();//生成所有表的HIBERNATE实体对象
