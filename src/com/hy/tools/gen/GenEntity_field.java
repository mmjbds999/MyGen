...
public class GenEntity_field {
	...
	public static void setGenerated(Object generated) {
		GenEntity_field.generated = generated;
	}
	...
	public static void setSchemaname(String schemaname) {
		GenEntity_field.schemaname = schemaname;
	}
	...
	public static Session getSession() {
		ApplicationContext context = new FileSystemXmlApplicationContext(new String[]{"/conf/all.xml"});  
	...
	public static void genEnt(String tabName){
		...
		if(tabName!=null&&!"".equals(tabName)&&!"null".equals(tabName)){
			...
			//赋值表对象
			String entityTemp = StringUtil.readFile(System.getProperty("user.dir")+TemplatePath.entity_field);
					...
					if(dbType.equals(DBType.mysql)){
						...
						if(table.getColumns()!=null&&table.getColumns().size()>0){
							for (Column column : table.getColumns()) {
								...
								String idFieldTemp = StringUtil.getMarkString(colFieldTemp, "<COL_ID>", "</COL_ID>");
								String idField = "";
								...
								if(many!=null&many.size()>0){
									for (String m : many) {
										...
										if(tab.equals(table.getName())&&mcol.equals(column.getName())){
											...
											colAttr.append(colAttrTemp.replace("<column_name_b>", StringUtil.upFirstChar(mcol))
	...
	public static void main(String[] args){
		GenEntity_field.genAll();//生成所有表的HIBERNATE实体对象
//		GenEntity_field.genEnt("article");//根据表名生成对应的HIBERNATE实体对象
	}
